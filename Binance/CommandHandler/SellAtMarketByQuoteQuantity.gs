var Binance_CommandHandler_SellAtMarketByQuoteQuantity = function(apiKey, apiSecret, fee) {
  ...
  this.handle = function(command) {
    ...
    var sellQuantity = quantityComputer.computeMaxBaseQuantityByQuoteQuantity(definition, command.quantity, lastPrice, fee);
